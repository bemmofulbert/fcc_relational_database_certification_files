...
--
-- Name: elements uniq_elements_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT uniq_elements_name UNIQUE (name);


--
-- Name: elements uniq_elements_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT uniq_elements_symbol UNIQUE (symbol);
